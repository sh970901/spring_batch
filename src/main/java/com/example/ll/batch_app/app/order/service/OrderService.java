package com.example.ll.batch_app.app.order.service;
...
import com.example.ll.batch_app.app.order.repository.OrderRepository;
...
@Transactional(readOnly = true) //밑에있는 모든게 readonly가 걸림
